...
export default function TextVsTextPage() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      const analysisResult: TextVsTextCheckOutput = await response.json();
    ...
    <>
      ...
      <div className="bg-white p-8 rounded-lg shadow-md mt-8 max-w-5xl mx-auto">
        ...
        <p className="text-gray-500 mb-6">
          Enter two pieces of text below to check for similarities.
        </p>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <div className="grid grid-cols-2 gap-6 mt-4">
                ...
                <div>
                  ...
                  <div className="mt-2 p-2 border rounded-md whitespace-pre-wrap">
                    {result.highlightedComparisonText}
                  </div>
                </div>
              </div>
            </div>
