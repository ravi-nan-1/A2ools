...
export default function AIContextualAnalysisPage() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      const response = await fetch('/api/ai-contextual-analysis', {
        method: 'POST',
        headers: {
      ...
      const analysisResult: AIContextualAnalysisOutput = await response.json();
  ...
  return (
    <>
      ...
      {/* PAGE CONTENT */}
      <div className="bg-white p-8 rounded-lg shadow-md mt-8 max-w-5xl mx-auto">
        <h2 className="text-xl font-semibold mb-4">AI Contextual Analysis</h2>
        <p className="text-gray-500 mb-6">
          Analyze text for subtle plagiarism like paraphrasing and structural similarity.
        </p>
          ...
          <div className="mt-8">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <div className="grid grid-cols-3 gap-4 mb-4">
                ...
                <div className="text-center">
                  <p className="font-semibold text-lg">
                    {result.paraphrasingScore}%
                  </p>
                  <p className="text-sm text-gray-500">Paraphrasing</p>
                </div>
                <div className="text-center">
                  <p className="font-semibold text-lg">
                    {result.structuralSimilarityScore}%
                  </p>
              ...
              <div className="mt-4">
                ...
                <div className="mt-2 p-2 border rounded-md whitespace-pre-wrap">
