...
const getConversionInfo = (conversionType: ConversionType): ConversionInfo => {
  ...
  switch (conversionType) {
    case "pdf-to-word":
      return { ...baseInfo, title: "PDF to Word", actionText: "Convert to Word", fromType: "PDF", toType: "Word" };
    ...
    case "split-pdf":
      return {
        ...
        fromType: "PDF",
        toType: "PDFs",
        params: [{ id: "ranges", label: "Page ranges", type: "text" }],
      };
